...
name: setup
description: >-
  Install Vale, write a .vale.ini, sync styles, and get a first run. Use when
  the user says "set up vale", "add vale", "add prose linting", or "lint our
  docs" in a repository that has no Vale config yet.
---
