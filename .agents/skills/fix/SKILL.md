...
name: fix
description: >-
  Run Vale, fix error-level alerts, and open a pull request per file. Use when
  the user says "run vale", "fix vale errors", "lint the docs", "fix the
  linter", or "make vale pass". Fixes errors only; leaves warnings and
