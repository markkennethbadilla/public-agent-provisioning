...
name: triage
description: >-
  Turn a large first Vale run into a decision per rule — fix, downgrade, or
  switch off. Use when the user says "too many alerts", "where do we start",
  "vale is too noisy", or has just added Vale to an existing corpus.
---
