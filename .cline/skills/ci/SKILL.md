...
name: ci
description: >-
  Run Vale in GitHub Actions, a pre-commit hook, or another runner. Use when the
  user says "add vale to CI", "run vale on PRs", "add a pre-commit hook", or
  "make the build fail on style errors".
---
